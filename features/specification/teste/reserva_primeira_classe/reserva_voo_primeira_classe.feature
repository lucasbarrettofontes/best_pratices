# language: pt
@reserva_voo_primeira_classe_3
@sprint_2
@reserva_voo
@primeira_classe
Funcionalidade: Reserva Voo Internacional Primeira Classe
 Como usuário do sistema
 Posso solicitar o agendamento de voo Internacional
 Para Validar o funcionamento da reserva de Voo na Primeira Classe

Contexto: Acessando o Sistema De Reserva de Voo
  Dado que eu esteja logado no sistema de Reserva de Voo com usuario default

@validar_valores_totais_voo_primeira_classe
Cenario: Validar os valores totais do Voo e a geracao do mesmo
  ...
  |  ida_e_volta   |    	1      |  Frankfurt  |		December       |	 30        |	Paris  |     February		   |		 15      |    First class   | Blue Skies Airlines|
  Quando seleciono pela compania e horario da partida "5:03" e retorno "14:30"
...
@validar_alert_endereco_fora_pais_primeira_classe
