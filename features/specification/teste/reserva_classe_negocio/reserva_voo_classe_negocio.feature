# language: pt
@reserva_voo_classe_negocio_2
@sprint_1
@reserva_voo
@classe_negocio
Funcionalidade: Reserva Voo Internacional Classe Negocio
 Como usuário do sistema
 Posso solicitar o agendamento de voo Internacional
 Para Validar o funcionamento da reserva de Voo na Classe de Negocio

Contexto: Acessando o Sistema De Reserva de Voo
  Dado que eu esteja logado no sistema de Reserva de Voo com usuario default

@validar_valores_totais_voo_classe_negocio
Cenario: Validar os valores totais do Voo e a geracao do mesmo
  ...
  |  ida_e_volta   |    	1      |  Frankfurt  |		December       |	   5       |	Paris  |     February		   |		 20      |  Business class  |Unified Airlines|
...
@validar_alert_endereco_fora_pais_classe_negocio
Cenario: Validar alert quando endereco for fora do Pais
  Dado preencho os detalhes do voo de acordo com o cenário de teste
  |   tipo_voo     | passageiros | partindo_de | mes_partida       | dia_partida | destino | mes_retorno       | dia_retorno | tipo_classe      | compania            |
  |  ida_e_volta   |    	1      |  Frankfurt  |		December       |	   5       |	Paris  |     February		   |		 20      |  Business class  | Pangaea Airlines 362|
  Quando seleciono pela compania e horario da partida "9:17" e retorno "16:37"
